...
public class SEDMailBoxTest extends TestUtils {
    ...
    public static void startClass() throws Exception {
        ...
        try {
            ...
            Files.copy(SEDMailBoxTest.class.getResourceAsStream("/pmode-conf.xml"), Paths.get(SED_HOME + "/pmode-conf.xml"), StandardCopyOption.REPLACE_EXISTING);
    ...
    public void test_A_SubmitMail() throws Exception {
        ...
        assertEquals("Response/RControl/@returnValue", mr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        ...
        assertEquals("SenderMessageId", mr.getRData().getSenderMessageId(), smr.getData().getOutMail().getSenderMessageId());
    ...
    public void test_B_SubmitMail_ValidationOfRequest() throws Exception {
        ...
        assertThrowErrorOnSubmit(smr, "Missing Data/OutMail/@ConversationId", SEDExceptionCode.MISSING_DATA);
        om.setConversationId(value);

        // check Data/OutMail/@senderMessageId
        value = om.getSenderMessageId();
        om.setSenderMessageId(null);
        assertThrowErrorOnSubmit(smr, "Missing Data/OutMail/@senderMessageId", SEDExceptionCode.MISSING_DATA);
        ...
        assertThrowErrorOnSubmit(smr, "Missing Data/OutMail/@ReceiverName", SEDExceptionCode.MISSING_DATA);
    ...
    public void test_C_SubmitMail_ExistsMail() throws Exception {
        ...
        assertEquals("Second submission Response/RControl/@returnValue", secmr.getRControl().getReturnValue().intValue(), SVEVReturnValue.WARNING.getValue());
        assertEquals("Second submission Response/RData/@submitDate", mr.getRData().getSubmittedDate(), secmr.getRData().getSubmittedDate());
        assertEquals("Second submission Response/RData/@mailId", mr.getRData().getMailId(), secmr.getRData().getMailId());
        assertEquals("Second submission Response/RData/@senderMessageId", mr.getRData().getSenderMessageId(), secmr.getRData().getSenderMessageId());
    ...
    public void test_D_GetOutMailList() throws Exception {
        ...
        assertEquals("Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        ...
        assertEquals("Response/RControl/@resultSize -> getOutMails().size()", mlr.getRData().getOutMails().size(), mlr.getRControl().getResultSize().intValue());
        assertEquals("Response/RControl/@resultSize -> getOutMails().size()", mlr.getRData().getOutMails().size(), mlr.getRControl().getResponseSize().intValue());
        ...
        assertEquals("Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("Response/RControl/@resultSize -> getOutMails().size()", mlr.getRData().getOutMails().size(), mlr.getRControl().getResultSize().intValue());
        assertEquals("Response/RControl/@resultSize -> increased", TEST_CNT + iResCNt, mlr.getRData().getOutMails().size());
        ...
        assertEquals("Service Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("Test service parameter", 1, mlr.getRData().getOutMails().size());

        assertEquals("Test service response id", om.getId(), mlr.getRData().getOutMails().get(0).getId());

        //test search for action
        omr.getData().setAction((om.getAction()));
        mlr = mTestInstance.getOutMailList(omr);
        omr.getData().setAction(null);
        assertEquals("Action Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("Test Action parameter", 1, mlr.getRData().getOutMails().size());
        assertEquals("Test  Action response id", om.getId(), mlr.getRData().getOutMails().get(0).getId());

        //test search for ConversationId
        omr.getData().setConversationId(om.getConversationId());
        mlr = mTestInstance.getOutMailList(omr);
        omr.getData().setConversationId(null);
        assertEquals("ConversationId Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("Test ConversationId parameter", 1, mlr.getRData().getOutMails().size());
        assertEquals("Test ConversationId response id", om.getId(), mlr.getRData().getOutMails().get(0).getId());

        //test search for SenderEBox
        omr.getData().setSenderEBox((om.getSenderEBox()));
        mlr = mTestInstance.getOutMailList(omr);
        omr.getData().setSenderEBox(null);
        assertEquals("SenderEBox Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("Test SenderEBox parameter", 1, mlr.getRData().getOutMails().size());
        assertEquals("Test SenderEBox response id", om.getId(), mlr.getRData().getOutMails().get(0).getId());

        //test search for ReceiverEBox
        omr.getData().setReceiverEBox((om.getReceiverEBox()));
        mlr = mTestInstance.getOutMailList(omr);
        omr.getData().setReceiverEBox(null);
        assertEquals("ReceiverEBox Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        ...
        mlr = mTestInstance.getOutMailList(omr);
        assertEquals("SubmittedDateFrom Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("service RControl/@ResultSize", TEST_CNT + iResCNt + 1, mlr.getRControl().getResultSize().intValue());
        assertEquals("service RControl/@getResponseSize", TEST_CNT, mlr.getRControl().getResponseSize().intValue());
    }
    ...
    public void test_E_GetOutMailEventList() throws Exception {
        ...
        assertEquals("Response/RControl/@resultSize -> OutMailEvent().size()", mer.getRData().getOutEvents().size(), mer.getRControl().getResultSize().intValue());
        assertEquals("Response/RControl/@resultSize -> OutMailEvent().size()", mer.getRData().getOutEvents().size(), mer.getRControl().getResponseSize().intValue());
        assertTrue("Response/RControl/@resultSize -> OutMailEvent().size()", mer.getRData().getOutEvents().size() > 0);
        ...
        assertEquals("Response/RControl/@returnValue", mer.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertTrue("Response/RControl/@resultSize -> OutMailEvent().size()", mer.getRData().getOutEvents().size() == iResult);
    }
    ...
    public void test_F_GetInMailList() throws Exception {
        ...
        assertNotNull("Response/RControl/@StartIndex", mlr.getRControl().getStartIndex());
        assertNotNull("Response/RData", mlr.getRData());
        assertEquals("Response/RControl/@resultSize -> getOutMails().size()", mlr.getRData().getInMails().size(), mlr.getRControl().getResultSize().intValue());
        assertEquals("Response/RControl/@resultSize -> getOutMails().size()", mlr.getRData().getInMails().size(), mlr.getRControl().getResponseSize().intValue());
        assertTrue("Response/RControl/@resultSize -> OutMailEvent().size()", mlr.getRData().getInMails().size() > 0);
        ...
        assertEquals("Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("Response/RControl/@resultSize -> getOutMails().size()", mlr.getRData().getInMails().size(), mlr.getRControl().getResultSize().intValue());
        assertEquals("Response/RControl/@resultSize -> increased", TEST_CNT + iResCNt, mlr.getRData().getInMails().size());
        ...
        assertEquals("Test service response id", im2.getId(), mlr.getRData().getInMails().get(0).getId());
        ...
        assertEquals("Test  Action response id", im2.getId(), mlr.getRData().getInMails().get(0).getId());
        ...
        assertEquals("Test ConversationId response id", im2.getId(), mlr.getRData().getInMails().get(0).getId());
        ...
        assertEquals("Test SenderEBox response id", im2.getId(), mlr.getRData().getInMails().get(0).getId());
        ...
        assertEquals("Test ReceiverEBox response id", im2.getId(), mlr.getRData().getInMails().get(0).getId());

        //test search for SubmittedDateFrom
        imr.getData().setReceivedDateFrom(dt);
        mlr = mTestInstance.getInMailList(imr);
        assertEquals("SubmittedDateFrom Response/RControl/@returnValue", mlr.getRControl().getReturnValue().intValue(), SVEVReturnValue.OK.getValue());
        assertEquals("Test SubmittedDateFrom parameter", TEST_CNT + 1, mlr.getRData().getInMails().size());
    ...
    public void test_G_GetInMailEventList() throws Exception {
        ...
        assertNotNull("Response/RControl/@StartIndex", mer.getRControl().getStartIndex());
        assertNotNull("Response/RData", mer.getRData());
        assertEquals("Response/RControl/@resultSize -> OutMailEvent().size()", mer.getRData().getInEvents().size(), mer.getRControl().getResultSize().intValue());
        assertEquals("Response/RControl/@resultSize -> OutMailEvent().size()", mer.getRData().getInEvents().size(), mer.getRControl().getResponseSize().intValue());
        assertTrue("Response/RControl/@resultSize -> OutMailEvent().size()", mer.getRData().getInEvents().size() > 0);
