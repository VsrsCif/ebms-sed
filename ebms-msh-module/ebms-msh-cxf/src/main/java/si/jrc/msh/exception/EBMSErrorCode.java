...
public enum EBMSErrorCode {
     ...
     *
     */
    ValueNotRecognized("EBMS:0001", "ValueNotRecognized", "failure", "Content",
     ...
     *
     */
    FeatureNotSupportedWarning("EBMS:0002", "FeatureNotSupported", "warning",
            "Content",
     ...
     *
     */
    ValueInconsistent("EBMS:0003", "ValueInconsistent", "failure", "Content",
     ...
     *
     */
    ConnectionFailure("EBMS:0005", "ConnectionFailure", "failure",
            "Communication",
     ...
     *
     */
    EmptyMessagePartitionChannel("EBMS:0006", "EmptyMessagePartitionChannel",
     ...
     *
     */
    FeatureNotSupportedFailure("EBMS:0008", "FeatureNotSupported", "failure",
            "Unpackaging",
     ...
     *
     */
    InvalidHeader("EBMS:0009", "InvalidHeader", "failure", "Unpackaging",
     ...
     *
     */
    ProcessingModeMismatch("EBMS:0010", "ProcessingModeMismatch", "failure",
            "Processing",
     ...
     *
     */
    ExternalPayloadError("EBMS:0011", "ExternalPayloadError", "failure",
            "Content",
     ...
     *
     */
    FailedAuthentication("EBMS:0101", "FailedAuthentication", "failure",
            "Processing",
     ...
     *
     */
    FailedDecryption("EBMS:0102", "FailedDecryption", "failure", "Processing",
     ...
     *
     */
    PolicyNoncompliance("EBMS:0103", "PolicyNoncompliance", "failure",
            "Processing",
     ...
     *
     */
    DysfunctionalReliability("EBMS:0201", "DysfunctionalReliability", "failure",
            "Processing",
     ...
     *
     */
    DeliveryFailure("EBMS:0202", "DeliveryFailure", "failure", "Communication",
     ...
     *
     */
    MissingReceipt("EBMS:0301", "MissingReceipt", "failure", "Communication",
     ...
     *
     */
    InvalidReceipt("EBMS:0302", "InvalidReceipt", "failure", "Communication",
     ...
     *
     */
    DecompressionFailure("EBMS:0303", "DecompressionFailure", "failure",
            "Communication",
    ...
    EBMSErrorCode(String cd, String nm, String sv, String ct, String desc,
            String org) {
        code = cd;
        name = nm;
        severity = sv;
