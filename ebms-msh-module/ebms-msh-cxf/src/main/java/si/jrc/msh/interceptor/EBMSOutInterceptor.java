...
public class EBMSOutInterceptor extends AbstractEBMSInterceptor {
  ...
  public void handleMessage(SoapMessage msg) {
    ...
    if (outMail != null) {
      ...
      try {
        ...
        throw ExceptionUtils.createSoapFault(SOAPExceptionCode.ConfigurationFailure, sv,
            ex.getSubMessage());
      }
    ...
    if (pmd.getLegs().get(0).getSecurity() != null) {
      ...
      try {
        sc =
            configureSecurityInterceptors(scPolicy, outMail != null ? outMail.getMessageId() : null);
   ...
   * @return
   */
  private Map<String, Object> createSignatureConfiguration(X509.Signature sig, String messageId)
      throws EBMSError {
    long l = LOG.logStart();
   ...
   * @return
   */
  private Map<String, Object> createEncryptionConfiguration(X509.Encryption enc, String messageId)
      throws EBMSError {
    long l = LOG.logStart();
    Map<String, Object> prps = null;
  ...
  private String getReferenceString(References ref, String messageId)
      throws EBMSError {
    long l = LOG.logStart();
  ...
  public WSS4JOutInterceptor configureSecurityInterceptors(Security sc, String msgId)
      throws EBMSError {
    long l = LOG.logStart();
